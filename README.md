...
- https://cryptohack.org/
    ...
    > To make an account you need to decrypt the secret phrase. It is a simple Caesar Cipher, Simply subtract 3 from the index value of each alphabet character to find the original plaintext of each character. Example: (Python List Index Format)`A[0]->D[3]` `Z[25]->C[2]` 
